...
// getProduct1() checks if the sum of 2 elements in an array equals 2020. 
// It then returns the product of those two elements.
int getProduct1(int arr[], size_t size) {
    ...
    for(int i = 0; i < size - 1; ++i) {
        for(int j = i + 1; j < size - 1; ++j) {
            ...
            if(arr[i] + arr[j] == 2020) {
                //printf("The two numbers that give you 2020 are %d and %d\n", arr[i], arr[j]);
                return arr[i] * arr[j];
            }
        }        
    }
...
// getProduct2() checks if the sum of 3 elements in an array equals 2020. 
// It then returns the product of those three elements.
int getProduct2(int arr[], size_t size) {
        ...
        for(int j = i + 1; j < size - 1; ++j) {
            for(int k = j + 1; k < size - 1; ++k) {
                ...
                if(arr[i] + arr[j] + arr[k]== 2020) {
                    //printf("The three numbers that give you 2020 are %d, %d and %d\n", arr[i], arr[j], arr[k]);
